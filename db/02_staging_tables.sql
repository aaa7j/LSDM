...
CREATE TABLE staging.team_stats_per_100 (
  ...
  g int,
  mp double precision,
  fg_per_100 double precision,
  fga_per_100 double precision,
  fg_percent double precision,
  x3p_per_100 double precision,
  x3pa_per_100 double precision,
  x3p_percent double precision,
  x2p_per_100 double precision,
  x2pa_per_100 double precision,
  x2p_percent double precision,
  e_fg_percent double precision,
  ft_per_100 double precision,
  fta_per_100 double precision,
  ft_percent double precision,
  orb_per_100 double precision,
  drb_per_100 double precision,
  trb_per_100 double precision,
  ast_per_100 double precision,
  stl_per_100 double precision,
  blk_per_100 double precision,
  tov_per_100 double precision,
  pf_per_100 double precision,
  pts_per_100 double precision
);
